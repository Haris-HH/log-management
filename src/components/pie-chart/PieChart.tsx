              ...
              return (
                <g>
                  <text
                    ...
                    style={{ fontSize: 52, fontWeight: 600, fill: "var(--primary-color)" }}
                  >
                  ...
                  <text
                    ...
                    textAnchor="middle"
                    dominantBaseline="middle"
                    style={{ fontSize: 18, fill: "rgba(var(--primary-color-rgb), 0.8)" }}
                  >
      ...
      <Box className="grid grid-cols-4 border border-(--primary-color) w-full overflow-hidden rounded-sm">
        {
          data.map((item, index) => (
            <Box 
              ...
              sx={{
                borderLeft: index === 0 ? "none" : "1px solid var(--primary-color)",
              }}
            >
              <Box className="flex flex-col items-center justify-center">
                <Typography sx={{ fontSize: 38, fontWeight: 500, color:'var(--primary-color)' }} variant='subtitle1'>
                  {item.value.toLocaleString()}
                </Typography>
                <Typography sx={{ fontSize: 14, fontWeight: 400, marginTop: -2.6, color:'var(--tertiary-color)' }} variant='subtitle1'>
              ...
              <Box className="flex items-center justify-center gap-1 -mt-2">
                ...
                />
                <Typography sx={{ fontSize: 16, fontWeight: 400, color:'var(--tertiary-color)' }} variant='subtitle1'>
                  {item.label}
                </Typography>
              </Box>
            </Box>
