...
export const generateStatisticAccessLogPdfBlob = async (
...
export const downloadStatisticAccessLogPdf = async (
  data: LogUsagePdfData,
  fileName: string,
  t: (key: string) => string,
  i18n: any
) => {
  const blob = await generateStatisticAccessLogPdfBlob(data, t, i18n);
