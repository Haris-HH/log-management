...
export const generateStatisticAccessAgencyPdfBlob = async (
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    header: () => ({
      columns: [
        {
          text: t('pdf.statistic-access-agency'),
          alignment: "left",
          color: "#ACACAC",
        },
        {
...
// Download
// --------------------
export const downloadStatisticAccessAgencyPdf = async (
  data: AgencyUsagePdfData,
  fileName: string,
  t: (key: string) => string,
  i18n: any
) => {
  const blob = await generateStatisticAccessAgencyPdfBlob(data, t, i18n);
