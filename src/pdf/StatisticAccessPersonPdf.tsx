...
export const generateStatisticAccessPersonPdfBlob = async (
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    header: () => ({
      columns: [
        {
          text: t('pdf.statistic-access-person'),
          alignment: "left",
          color: "#ACACAC",
        },
        {
...
export const downloadStatisticAccessPersonPdf = async (
  data: PersonUsagePdfData,
  fileName: string,
  t: (key: string) => string,
  i18n: any
) => {
  const blob = await generateStatisticAccessPersonPdfBlob(data, t, i18n);
