...
// Types
import type { UsageLog, NsbBk, NsbOrg } from "../types/common";
...
const StatisticUsagePerson = () => {
  ...
  const mapUsageLogRows = useCallback(
    ...
    [formData, page, title, agency, rowsPerPage, bh, bk, org, i18n.language, i18n.isInitialized]
  );
      ...
      <div className='p-4 bg-(--theme-bg-body) flex flex-1 flex-col gap-4 min-h-0 w-full rounded-lg border border-(--theme-accent) overflow-y-auto'>
        ...
        >
          ...
          <Box className="flex gap-2 items-end">
            ...
            <GroupExportButton 
              groupKey="statistic-usage-person"
